...
@section('content_myaccount')
                                    ...
                                    <div class="account_purchase_header">
                                        ...
                                        <div class="account_purchase_header_right">
                                            <p class="account_purchase_header_right_1">
                                                <button class="account_purchase_header_right_confir">
                                                    <a href="javascript:void(0);" onclick="noticeConfirm();"
                                                        class="">Đã xác nhận
                                                        đơn hàng</a></button>
                                            </p>
                                        ...
                                        <div class="account_purchase_mobile">
                                            <div class="account_purchase_mobile_main">
                                                <button class="account_purchase_mobile_confir">
                                                    <a href="javascript:void(0);" onclick="noticeConfirm();"
                                                        class="">Đã xác nhận
                                                        đơn hàng</a></button>
    ...
    <script>
        function noticeConfirm() {
            Swal.fire({
                imageUrl: "{{ asset('img/confirm.png') }}",
                imageHeight: 150,
                imageWidth: 150,
