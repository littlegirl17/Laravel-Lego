                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            id: "htmlPreview",
                            style: "width:95%;",
                            html: "<div>" + CKEDITOR.tools.htmlEncode(d.lang.common.preview) + '<br><div id="' + m + '" class="ImagePreviewLoader" style="display:none"><div class="loading">&nbsp;</div></div><div class="ImagePreviewBox"><table><tr><td><a href="javascript:void(0)" target="_blank" onclick="return false;" id="' + B + '"><img id="' + A + '" alt="" /></a>' + (d.config.image_previewText || "") +
                                "</td></tr></table></div></div>"
                        }]
                    }]
                }]
